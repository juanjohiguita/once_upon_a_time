...
import 'form_story_widget.dart' show FormStoryWidget;
...
class FormStoryModel extends FlutterFlowModel<FormStoryWidget> {
  ...
  // State field(s) for DD_duration widget.
  String? dDDurationValue;
  FormFieldController<String>? dDDurationValueController;
